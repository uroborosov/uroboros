...
On first launch, the wizard will ask for your [Cloud.ru API key](https://cloud.ru).
...
|-----|----------|-----------------|
| Cloud.ru API Key | **Yes** | [cloud.ru](https://cloud.ru) — Service Accounts → API Keys |
...
|------|---------|---------|
| Main | `zai-org/GLM-4.7` | Primary reasoning |
| Code | `zai-org/GLM-4.7` | Code editing |
| Light | `zai-org/GLM-4.7` | Safety checks, consciousness, fast tasks |
| Fallback | `zai-org/GLM-4.7` | When primary model fails |
| Web Search | `zai-org/GLM-4.7` | Web search |

Models are configurable in the Settings page. All LLM calls go through [Cloud.ru Foundation Models](https://cloud.ru/docs/foundation-models/ug/index) (except web search, which uses OpenAI directly).
