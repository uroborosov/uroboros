...
_DEFAULT_VLM_MODEL = "GigaChat/GigaChat-2-Max"


def _get_vlm_model() -> str:
    """Get VLM model from dedicated env var or use vision-safe default."""
    model = os.environ.get("OUROBOROS_MODEL_VISION", "").strip()
    if model:
        return model
