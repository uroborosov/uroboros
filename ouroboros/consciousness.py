...
class BackgroundConsciousness:
    ...
    def _check_budget(self) -> bool:
        ...
        try:
            ...
            return self._bg_spent_rub < max_bg
        except Exception:
    ...
    def _build_context(self) -> str:
        ...
        runtime_lines.append(f"BG budget spent: {self._bg_spent_rub:.4f} ₽")
        ...
        try:
            ...
            if state_path.exists():
                ...
                total_budget = float(os.environ.get("TOTAL_BUDGET", "1000"))
                spent = float(state_data.get("spent_rub") or state_data.get("spent_usd") or 0)
                if total_budget > 0:
