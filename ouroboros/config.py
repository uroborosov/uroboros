...
SETTINGS_DEFAULTS = {
    ...
    # Default main model: zai-org/GLM-4.7
    "OUROBOROS_MODEL": "zai-org/GLM-4.7",
    "OUROBOROS_MODEL_CODE": "zai-org/GLM-4.7",
    "OUROBOROS_MODEL_LIGHT": "zai-org/GLM-4.7",
    "OUROBOROS_MODEL_FALLBACK": "zai-org/GLM-4.7",
    ...
    "OUROBOROS_EVO_COST_THRESHOLD": 10.0,
        ...
        if SETTINGS_PATH.exists():
            try:
                ...
                if isinstance(settings, dict):
                    # Backward compat: migrate legacy OPENROUTER_API_KEY → API_KEY at read time.
                    if not settings.get("API_KEY") and settings.get("OPENROUTER_API_KEY"):
                        settings["API_KEY"] = settings["OPENROUTER_API_KEY"]
                return settings
            except Exception:
                pass
